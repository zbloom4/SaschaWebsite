					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
						...
						<div class="slide-caption">
                            <div class="caption-content">
                                <h2 class="animated fadeInDown">Sascha Alexia</h2>
                                <span class="animated fadeInDown">Portfolio</span>
                                <a href="#" class="btn btn-blue btn-effect">Resume</a>
                            </div>
                        </div>
					...
					<div class="row">
						<div class="col-md-4 wow animated fadeInLeft">
							<div class="recent-works">
								...
								<div id="works">
									<div class="work-item">
										<p>My name is Sascha Alexia and I am a senior at CSU Chico. I will be graduating in May 2016 with a Bachelor's Degree in Communication Design with an emphasis in Media arts and a minor in Broadcasting. I am currently an intern at BCAC Chanel 11, a non-profit television station, in Chico, Ca as their editor for television content, director, and technical director.</p>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-7 col-md-offset-1 wow animated fadeInRight">
							<div class="welcome-block">
						     	 <div class="message-body">
									<img src="img/sascha.jpg" class="pull-right" alt="member">
						       		<p>I am proficient in:
										<ul>
										    <li>Microsoft Office</li>
                                            <li>Avid Media Composer</li>
										    <li>Final Cut Pro X</li>
                                            <li>Operate Tricaster 410 Switcher</li>
                                            <li>Protools</li>
                                            <li>Adobe Suite</li>
                                            <li>Illustrator</li>
										    <li>Photoshop</li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="sec-title text-center">
							<h2 class="wow animated bounceInLeft">My Work</h2>
							<p class="wow animated bounceInRight">Most Recent Projects in Audio/Video</p>
						</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 text-center wow animated zoomIn">
							<div class="service-item">
								...
								<h3>Visual Biography of Myself</h3>
                                <p>Shot and edited in Avid Media Composer by me.</p>
                                <iframe style="margin-bottom: 30px" width="560" height="315" src="https://www.youtube.com/embed/bLYDI_YjaG4" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>


						<div class="col-md-12 col-sm-12 col-xs-12 text-center wow animated zoomIn" data-wow-delay="0.6s">
							<div class="service-item">
								<div class="service-icon">
									<i class="fa fa-clock-o fa-3x"></i>
								</div>
								<h3>News Broadcast</h3>
								<p>Shot and edited in iMovie by me.</p>
                                <iframe style="margin-bottom: 30px" width="560" height="315" src="https://www.youtube.com/embed/7MvyBlpWLEk" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
						...
						<div class="col-md-12 col-sm-6 col-xs-12 text-center wow animated zoomIn" data-wow-delay="0.9s">
							<div class="service-item">
								...
								<h3>Snowboarding Video</h3>
                                <p>Edited in Avid Media Composer by me.</p>
                                <iframe style="margin-bottom: 30px" width="560" height="315" src="https://www.youtube.com/embed/xKVruEC--zc" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12 text-center wow animated zoomIn" data-wow-delay="0.9s">
							<div class="service-item">
								...
								<h3>Radio News Audio</h3>
                                <p>Sound clip read and formatted to better suit the radio.</p>
                                <iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/230048970&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<ul class="project-wrapper wow animated fadeInUp">
							...
							<li class="portfolio-item">
								...
								<ul class="external">
									<li><a class="fancybox" title="Wall street" href="img/saschaProducer.jpg" data-fancybox-group="works" ><i class="fa fa-search"></i></a></li>
									<li><a href=""><i class="fa fa-link"></i></a></li>
								</ul>
							</li>
